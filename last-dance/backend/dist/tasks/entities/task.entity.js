...
let Task = class Task {
    isOverdue() {
        const isFinished = this.status === task_status_enum_1.TaskStatus.COMPLETED || this.status === task_status_enum_1.TaskStatus.CANCELLED;
        if (isFinished)
            return false;
...
__decorate([
    (0, typeorm_1.Column)({ type: 'varchar', length: 20, default: task_status_enum_1.TaskStatus.PENDING }),
    __metadata("design:type", String)
