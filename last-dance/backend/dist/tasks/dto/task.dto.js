...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Nộp báo cáo giữa kỳ' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: 'assignment' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: 'P.302 - A1' }),
    (0, class_validator_1.IsOptional)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: 'Nhớ mang theo laptop' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Ghi chú phải là chuỗi' }),
    __metadata("design:type", String)
], CreateTaskDto.prototype, "notes", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, enum: task_status_enum_1.TaskStatus, example: task_status_enum_1.TaskStatus.PENDING }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(task_status_enum_1.TaskStatus, { message: 'Trạng thái công việc không hợp lệ' }),
    __metadata("design:type", String)
], CreateTaskDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ required: false, example: 1, description: 'ID môn học liên quan' }),
    (0, class_validator_1.IsOptional)(),
