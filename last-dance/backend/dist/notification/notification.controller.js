...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Danh sách toàn bộ nhắc nhở' }),
    (0, common_1.Get)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Danh sách nhắc nhở theo 1 công việc (Task)' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Tạo bản ghi nhắc nhở thủ công' }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Cập nhật trạng thái 1 nhắc nhở' }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Huỷ nhắc nhở (chỉ khi đang PENDING)' }),
